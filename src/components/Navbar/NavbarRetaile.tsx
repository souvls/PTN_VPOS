...
const NavbarRetaile: React.FC<UserProps> = ({ id, username, user_name, user_role }) => {
        ...
        <div>
            <div className='w-full bg-blue-600  py-3'>
                <div className=' flex justify-between items-center'>
                    ...
                    <div className='me-10'>
                        <Link href={"retail"} target='bank' className=' bg-white p-2 rounded-lg'>ເປີດໜ້າໃໝ່</Link>
                    </div>
                </div>
            </div>
        </div>
